...
<body >
  ...
  <div id="mws-header" class="clearfix" style="height:150px">    
        ...
        <h1 class="Estilo1">Acreditación de Personeros</h1>
		<div class="pull-right">
                        <form class="mws-form" action="cLogica/lCrm_usuario.php?opcion=logueo" method="post" id="frmlogin" name="frmlogin">
                    <div class="mws-form-row">
                        <div class="mws-form-item">
                            <input type="text" id="username" name="username" class="mws-login-username required" placeholder="DNI">
                        <input type="submit" value="Entrar" class="btn btn-success mws-login-button">
                    </div>
					</div>
                </form>
				</div>
