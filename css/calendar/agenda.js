...
function fHoliday(y,m,d) {
	...
	if (m==1&&d==1)
		r=[" Enero 1, "+y+" \n Feliz Año Nuevo "+y,gsAction,"skyblue","red"];
	else if (m==12&&d==25)
		r=[" Diciembre 25, "+y+" \n Feliz Navidad "+y,gsAction,"skyblue","red"];
	else if (m==12&&d==31)
		r=[" Diciembre 25, "+y+" \n Feliz Año Nuevo "+y,gsAction,"skyblue","red"];
	else if (m==12&&d==28)
		r=[" Diciembre 28, "+y+" \n Cuempleaños Web Master Kenett Serrano",gsAction,"skyblue","red"];
	else if (m==7&&d==28)
		r=[" Julio 28, "+y+" \n Dia de la Independencia de Peru ",gsAction,"skyblue","red"];
	else if (m==11&&d==11)
		r=[" Nov 11, "+y+" \n Veteran's Day ",gsAction,"skyblue","red"];
	else if (m==5&&d<25) {
		var date=fGetDateByDOW(y,5,3,7);
		if (d==date) r=[" Mayo "+d+", "+y+" \n Dia de las Madres",gsAction,"skyblue","red"];
	}	
